...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DdosProtectionPlanPropertiesFormat) DeepCopyInto(out *DdosProtectionPlanPropertiesFormat) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DdosProtectionPlanPropertiesFormat.
func (in *DdosProtectionPlanPropertiesFormat) DeepCopy() *DdosProtectionPlanPropertiesFormat {
	if in == nil {
		return nil
	}
	out := new(DdosProtectionPlanPropertiesFormat)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DdosProtectionPlanSpec) DeepCopyInto(out *DdosProtectionPlanSpec) {
	*out = *in
	...
	in.DdosProtectionPlanPropertiesFormat.DeepCopyInto(&out.DdosProtectionPlanPropertiesFormat)
