...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InterfaceIPConfiguration) DeepCopyInto(out *InterfaceIPConfiguration) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InterfaceIPConfiguration.
func (in *InterfaceIPConfiguration) DeepCopy() *InterfaceIPConfiguration {
	if in == nil {
		return nil
	}
	out := new(InterfaceIPConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkInterfaceFormat) DeepCopyInto(out *NetworkInterfaceFormat) {
	*out = *in
	if in.IPConfigurations != nil {
		in, out := &in.IPConfigurations, &out.IPConfigurations
		*out = make([]*InterfaceIPConfiguration, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(InterfaceIPConfiguration)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkInterfaceFormat.
func (in *NetworkInterfaceFormat) DeepCopy() *NetworkInterfaceFormat {
	if in == nil {
		return nil
	}
	out := new(NetworkInterfaceFormat)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NetworkInterfaceSpec) DeepCopyInto(out *NetworkInterfaceSpec) {
	*out = *in
	...
	in.NetworkInterfaceFormat.DeepCopyInto(&out.NetworkInterfaceFormat)
	if in.Tags != nil {
...
func (in *PublicIPAddressSpec) DeepCopyInto(out *PublicIPAddressSpec) {
	*out = *in
	...
	out.PublicIPAddressFormat = in.PublicIPAddressFormat
	if in.Tags != nil {
		in, out := &in.Tags, &out.Tags
		*out = make(map[string]*string, len(*in))
		for key, val := range *in {
