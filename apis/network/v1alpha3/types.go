...
// PrivateEndpointList contains a list of PublicIPAddress items
...
type PrivateEndpointSpec struct {
	...
	// ResourceGroupName - Name of the Private Endpoint's resource group.
	ResourceGroupName string `json:"resourceGroupName,omitempty"`
	...
	// PrivateConnectionDetails - Properties of the Private Connection Details.
	PrivateConnectionDetails `json:"privateConnectionDetails"`

	// The id of the subnet
	// +optional
	SubnetId string `json:"subnetId"`

	// SubnetIDRef - A reference to a Subnet to retrieve its ID
	SubnetIdRef *xpv1.Reference `json:"subnetIdRef,omitempty"`

	// SubnetIDSelector - Select a reference to a Subnet to retrieve
	// its ID
...
// A PrivateEndpointStatus represents the observed state of a PrivateEndpoint.
type PrivateEndpointStatus struct {
	xpv1.ResourceStatus `json:",inline"`

	AtProvider PrivateEndpointStatusObservation `json:"atProvider"`
}

// A PrivateEndpointStatusObservation represents the observed state of a PrivateEndpoint.
type PrivateEndpointStatusObservation struct {
	// State of this PrivateEndpoint.
	State string `json:"state,omitempty"`

	// A Message providing detail about the state of this Private Endpoint, if
	// any.
	Message string `json:"message,omitempty"`
	...
	// ResourceGUID - The GUID of this PrivateEndpoint.
	ResourceGUID string `json:"resourceGuid,omitempty"`
...
type PrivateConnectionDetails struct {
	IsManualConnection bool   `json:"isManualConnection"`
	...
	PrivateConnectionResourceIdSelector *xpv1.Selector  `json:"privateConnectionResourceSelector,omitempty"`
}
