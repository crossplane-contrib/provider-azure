...
import (
	...
	v1alpha2 "github.com/crossplane-contrib/provider-jet-azure/apis/resources/v1alpha2"
)
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	r := managed.NewReconciler(mgr,
		...
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["azurerm_resource_group_template_deployment"],
			tjcontroller.WithCallbackProvider(tjcontroller.NewAPICallbacks(mgr, xpresource.ManagedKind(v1alpha2.ResourceGroupTemplateDeployment_GroupVersionKind))),
		)),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha2.ResourceGroupTemplateDeployment{}).
