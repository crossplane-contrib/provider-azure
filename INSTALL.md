...
You can build the Crossplane Azure Stack for the host platform by simply running the command below.
...
TBD: Steps to install the Azure stack into a Crossplane cluster
