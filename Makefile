...
GO_STATIC_PACKAGES = $(GO_PROJECT)/cmd/stack-azure
GO_LDFLAGS += -X $(GO_PROJECT)/pkg/version.Version=$(VERSION)
GO_SUBDIRS += cmd pkg azure
...
manifests: vendor
	...
	go run vendor/sigs.k8s.io/controller-tools/cmd/controller-gen/main.go crd:trivialVersions=true paths=./azure/... output:dir=$(CRD_DIR)
